...
use TopRedMedia\SAML\Events\UserLoggedOutEvent;
...
class Auth
{
    ...
    /**
     * Auth constructor. Initializes auth with settings for given isp.
     *
     * @param $isp
     * @throws ISPSettingsNotFoundException
     * @throws OneLogin_Saml2_Error
     */
    function __construct($isp)
    {
        $this->isp = $isp;
    ...
    {
        return new SAMLUser($this->isp, $this->auth);
    }
    ...
    function sls($retrieveParametersFromServer = false)
    {
        ...
        $session_callback = function () {
            event(new UserLoggedOutEvent($this->isp));
        };
